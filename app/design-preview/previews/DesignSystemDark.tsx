...
// ─── Semantic Tokens (dark values only) ──────────────────────────────────────
...
const tokensBorder = [
  { hex: '#2a2a2a', label: 'border/default' },
...
function Swatch({ hex, label }: { hex: string; label: string }) {
  return (
    <div className="flex flex-col items-center gap-1">
      <div
        className="w-16 h-16"
        style={{ background: hex, border: `1px solid ${D.border}` }}
      />
      <span className="text-[10px] tracking-wide" style={{ color: D.muted }}>{label}</span>
      <span className="text-[10px] font-mono" style={{ color: D.muted }}>{hex}</span>
    </div>
  )
}
    ...
    >
      ...
      <section>
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="text-[10px] tracking-wide mb-3" style={{ color: D.muted }}>danger/ + success/</div>
            <div className="flex flex-wrap gap-4">
